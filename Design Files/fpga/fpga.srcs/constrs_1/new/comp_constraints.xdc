...
set_property -dict {PACKAGE_PIN G1 IOSTANDARD LVCMOS33} [get_ports {G}]
set_property -dict {PACKAGE_PIN G2 IOSTANDARD LVCMOS33} [get_ports {E}]
set_property -dict {PACKAGE_PIN F1 IOSTANDARD LVCMOS33} [get_ports {L}]
